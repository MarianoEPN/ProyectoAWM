...
router.patch('/:id/baja',/* verificarToken, verificarRol(['Administrador']),*/ ctrl.darDeBaja); 
router.post('/:id/regenerar-qr',/* verificarToken, verificarRol(['Administrador']),*/ ctrl.regenerarQr); 
